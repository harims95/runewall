...
class CliTests(unittest.TestCase):
    ...
    def test_package_build_check_json_exits_zero(self) -> None:
        ...
        self.assertEqual(data["checks"]["version"]["value"], "1.0.0rc1")
    ...
    def test_package_dist_check_json_returns_valid_json(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            dist_dir.mkdir()
            (dist_dir / "runewall-1.0.0rc1-py3-none-any.whl").write_text("", encoding="utf-8")
            (dist_dir / "runewall-1.0.0rc1.tar.gz").write_text("", encoding="utf-8")
    ...
    def test_package_verify_example_json_returns_ok_true(self) -> None:
        ...
        data = json.loads(output.getvalue())
        self.assertTrue(data["ok"])
        self.assertEqual(data["package"]["name"], "github-safe-issue-map")
        self.assertEqual(data["package"]["version"], "0.1.0")
        self.assertEqual(data["package"]["maps_count"], 1)
        self.assertTrue(data["validation"]["ok"])
        self.assertTrue(data["checksums"]["verified"])
        self.assertFalse(data["signing"]["implemented"])
    ...
    def test_package_verify_missing_directory_returns_failure(self) -> None:
        ...
        self.assertIn("signing", data)
        self.assertIn("trusted_key", data)
    ...
    def test_mcp_serve_once_handles_initialize(self) -> None:
        ...
        self.assertEqual(data["result"]["serverInfo"]["version"], "1.0.0rc1")
    ...
    def test_version_prints_human_readable_output(self) -> None:
        ...
        self.assertEqual(rendered, "Runewall 1.0.0rc1")
